        ...
        <div class="controls">
            ...
            <script type="text/template" id="enterpriseBusinessTypeRelationTpl">//<!--
						<tr id="enterpriseBusinessTypeRelationList{{idx}}">
							...
							<td>
							<select id="enterpriseBusinessTypeRelationList{{idx}}_businessTypeId" name="enterpriseBusinessTypeRelationList[{{idx}}].businessTypeId" data-value="{{row.businessTypeId}}" class="input-small ">
									<option value=""></option>
        ...
        <div class="controls">
            ...
            <script type="text/template" id="enterprisePollutionTypeRelationTpl">//<!--
						<tr id="enterprisePollutionTypeRelationList{{idx}}">
							...
							<td>
							<select id="enterprisePollutionTypeRelationList{{idx}}_pollutionTypeId" name="enterprisePollutionTypeRelationList[{{idx}}].pollutionTypeId" data-value="{{row.pollutionTypeId}}" class="input-small ">
									<option value=""></option>
