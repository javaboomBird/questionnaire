...
<ul class="nav nav-tabs">
    ...
    <shiro:hasPermission name="eiareport:eiaReport:edit">
        <li><a href="${ctx}/eiareport/eiaReport/form">环评报告信息管理添加</a></li>
    </shiro:hasPermission>
</ul>
<form:form id="searchForm" modelAttribute="eiaReport" action="${ctx}/eiareport/eiaReport/"
           method="post" class="breadcrumb form-search">
    <input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}"/>
    <input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
    <ul class="ul-form">
        <li><label>排污类型：</label>
            <sys:dynamicselect url="{customer}/pt/pollutionType/api/getAll" cssClass="input-medium"
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <c:forEach items="${page.list}" var="eiaReport">
        <tr>
            <td>
                <a href="${ctx}/eiareport/eiaReport/form?id=${eiaReport.id}">
            ...
            <shiro:hasPermission name="eiareport:eiaReport:edit">
                <td>
                    ...
                    <a href="${ctx}/eiareport/eiaReport/delete?id=${eiaReport.id}"
