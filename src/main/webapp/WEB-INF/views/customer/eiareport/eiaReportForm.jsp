...
<body>
	...
	<form:form id="inputForm" modelAttribute="eiaReport" action="${ctx}/eiareport/eiaReport/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
        <sys:dynamicselect url="http://127.0.0.1:8081/enterprise/enterprise/api/getAll" id="enterpriseId" name="enterpriseId" valueProperty="id" textProperty="enterpriseName" />
		...
		<div class="control-group">
			...
			<div class="controls">
        <sys:dynamicselect url="http://127.0.0.1:8081/pt/pollutionType/api/getAll" id="pollutionTypeId" name="pollutionTypeId" valueProperty="id" textProperty="pollutionTypeName" />
			</div>
		</div>
		<div class="control-group">
