...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a
            href="${ctx}/government/government/form?id=${government.id}">政府信息管理<shiro:hasPermission
            name="government:government:edit">${not empty government.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
            name="government:government:edit">查看</shiro:lacksPermission></a></li>
</ul>
<br/>
<form:form id="inputForm" modelAttribute="government" action="${ctx}/government/government/save"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:input path="governmentName" htmlEscape="false" maxlength="64"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <sys:treeselect id="area" property="areaId" name="area.id" value="${government.area.id}"
                            labelName="area.name" labelValue="${government.area.name}"
        ...
        <div class="controls">
            <table id="contentTable_contact"
                ...
                <tr>
                    ...
                    <th>邮箱</th>
                    <th>备注</th>
                    <shiro:hasPermission name="government:government:edit">
                        <th width="10">&nbsp;</th>
                    </shiro:hasPermission>
                </tr>
                </thead>
            ...
            <script type="text/template" id="contactTpl">//<!--
						<tr id="contactList{{idx}}">
							<td class="hide">
								...
								<input id="contactList{{idx}}_delFlag" name="contactList[{{idx}}].isDeleted" type="hidden" value="N"/>
							</td>
							<%--<td>--%>
    ...
    <div class="form-actions">
        <shiro:hasPermission name="government:government:edit"><input id="btnSubmit"
