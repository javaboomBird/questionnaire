						...
						<table id="contentTable" class="table table-striped table-bordered table-condensed">
							...
							<c:forEach items="${genTable.columnList}" var="column" varStatus="vs">
								<tr${column.isDeleted eq 'Y'?' class="error" title="已删除的列，保存之后消失！"':''}>
									...
									<td>
										<input type="text" name="columnList[${vs.index}].url" value="${column.url}" maxlength="200" class="input-mini"/>
									</td>
									<td>
										<input type="text" name="columnList[${vs.index}].textValue" value="${column.textValue}" maxlength="200" class="input-mini"/>
									</td>
									<td>
