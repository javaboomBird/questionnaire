...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/customer/enterprise">企业信息管理列表</a></li>
    <li class="active"><a
            href="${ctx}/customer/enterprise/form?id=${enterprise.id}">企业信息管理<shiro:hasPermission
            name="customer:enterprise:edit">${not empty enterprise.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
            name="customer:enterprise:edit">查看</shiro:lacksPermission></a></li>
</ul>
<br/>
