...
<ul class="nav nav-tabs">
    ...
    <shiro:hasPermission name="group:sysGroup:edit">
        <li><a href="${ctx}/group/sysGroup/form">分组管理添加</a></li>
    </shiro:hasPermission>
</ul>
<form:form id="searchForm" modelAttribute="sysGroup" action="${ctx}/group/sysGroup/" method="post"
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <c:forEach items="${page.list}" var="sysGroup">
        <tr>
            ...
            <td>
                    ${fns:getDictLabel(sysGroup.groupType, 'sys_group_type', '')}
            </td>
            <td>
                    ${sysGroup.remarks}
            </td>
            <shiro:hasPermission name="group:sysGroup:edit">
                <td>
                    ...
                    <a href="${ctx}/group/sysGroup/delete?id=${sysGroup.id}"
                       onclick="return confirmx('确认要删除该分组管理吗？', this.href)">删除</a>
                </td>
            </shiro:hasPermission>
        </tr>
    </c:forEach>
