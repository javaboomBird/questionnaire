...
<ul class="nav nav-tabs">
    ...
    <li class="active">
        <a href="${ctx}/contract/good/form?id=${good.id}">合同商品<shiro:hasPermission name="contract:good:edit">${not empty good.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="contract:good:edit">查看</shiro:lacksPermission></a>
    </li>
</ul>
<br/> <form:form
        id="inputForm"
        modelAttribute="good"
        action="${ctx}/contract/good/save"
        method="post"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:select
                    ...
                    value=""
                    label=""/> <form:options
                    items="${fns:getDictList('ecm_good_type')}"
                    itemLabel="label"
                    itemValue="value"
    ...
    <div class="form-actions">
        <shiro:hasPermission name="contract:good:edit"><input
                id="btnSubmit"
