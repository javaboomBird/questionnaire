...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/contract/contract/form?id=${contract.id}">合同<shiro:hasPermission name="contract:contract:edit">${not empty contract.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="contract:contract:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="contract" action="${ctx}/contract/contract/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:radiobuttons path="supplemental" items="${fns:getDictList('boolean')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">是否虚拟合同：</label>
			<div class="controls">
				<form:radiobuttons path="virtual" items="${fns:getDictList('boolean')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">主合同编号：</label>
			<div class="controls">
				<form:input path="majorContractId" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">合同项目名称：</label>
			<div class="controls">
				<form:input path="projectName" htmlEscape="false" maxlength="128" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">合同状态：</label>
			<div class="controls">
				<form:radiobuttons path="status" items="${fns:getDictList('ecm_contract_status')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">合同类别：</label>
			<div class="controls">
				<form:radiobuttons path="type" items="${fns:getDictList('ecm_contract_type')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">合同级别：</label>
			<div class="controls">
				<form:radiobuttons path="level" items="${fns:getDictList('ecm_contract_level')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">合同总价：</label>
			<div class="controls">
				<form:input path="contractTotalPrice" htmlEscape="false" class="input-xlarge  number"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="maintainTotalPrice" htmlEscape="false" class="input-xlarge  number"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="firstParty" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">甲方联系人：</label>
			<div class="controls">
				<form:input path="firstPartyContact" htmlEscape="false" maxlength="32" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">甲方联系人电话：</label>
			<div class="controls">
				<form:input path="firstPartyContactPhone" htmlEscape="false" maxlength="32" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">乙方：</label>
			<div class="controls">
				<form:input path="secondParty" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">乙方联系人：</label>
			<div class="controls">
				<form:input path="secondPartyContact" htmlEscape="false" maxlength="32" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">乙方联系人电话：</label>
			<div class="controls">
				<form:input path="secondPartyContactPhone" htmlEscape="false" maxlength="32" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">丙方：</label>
			<div class="controls">
				<form:input path="thirdParty" htmlEscape="false" maxlength="64" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">丙方联系人：</label>
			<div class="controls">
				<form:input path="thirdPartyContact" htmlEscape="false" maxlength="32" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">丙方联系人电话：</label>
			<div class="controls">
				<form:input path="thirdPartyContactPhone" htmlEscape="false" maxlength="32" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">交付地点：</label>
			<div class="controls">
				<form:input path="deliveryPlace" htmlEscape="false" maxlength="128" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">服务期限：</label>
			<div class="controls">
				<form:input path="serviceTerm" htmlEscape="false" maxlength="32" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					<table id="contentTable_contractAttachment" class="table table-striped table-bordered table-condensed">
						<thead>
							<tr>
								<th class="hide"></th>
								<th>文件描述</th>
								...
								<th>文件类型</th>
								<th>文件路径</th>
								<shiro:hasPermission name="contract:contract:edit"><th width="10">&nbsp;</th></shiro:hasPermission>
							</tr>
						</thead>
						<tbody id="contractAttachmentList">
						</tbody>
						<shiro:hasPermission name="contract:contract:edit"><tfoot>
							<tr><td colspan="6"><a href="javascript:" onclick="addRow('#contractAttachmentList', contractAttachmentRowIdx, contractAttachmentTpl);contractAttachmentRowIdx = contractAttachmentRowIdx + 1;" class="btn">新增</a></td></tr>
						</tfoot></shiro:hasPermission>
					</table>
					<script type="text/template" id="contractAttachmentTpl">//<!--
					...
					<script type="text/javascript">
						var contractAttachmentRowIdx = 0, contractAttachmentTpl = $("#contractAttachmentTpl").html().replace(/(\/\/\<!\-\-)|(\/\/\-\->)/g,"");
						$(document).ready(function() {
							var data = ${fns:toJson(contract.contractAttachmentList)};
							for (var i=0; i<data.length; i++){
								addRow('#contractAttachmentList', contractAttachmentRowIdx, contractAttachmentTpl, data[i]);
			...
			<div class="control-group">
				...
				<div class="controls">
					<table id="contentTable_contractGood" class="table table-striped table-bordered table-condensed">
						<thead>
							<tr>
								<th class="hide"></th>
								<th>商品 id</th>
						...
						<tbody id="contractGoodList">
						</tbody>
						<shiro:hasPermission name="contract:contract:edit"><tfoot>
							<tr><td colspan="6"><a href="javascript:" onclick="addRow('#contractGoodList', contractGoodRowIdx, contractGoodTpl);contractGoodRowIdx = contractGoodRowIdx + 1;" class="btn">新增</a></td></tr>
						</tfoot></shiro:hasPermission>
					</table>
					<script type="text/template" id="contractGoodTpl">//<!--
					...
					<script type="text/javascript">
						var contractGoodRowIdx = 0, contractGoodTpl = $("#contractGoodTpl").html().replace(/(\/\/\<!\-\-)|(\/\/\-\->)/g,"");
						$(document).ready(function() {
