            ...
            <script
                    ...
                    id="contractGoodTpl">//<!--
						<tr id="contractGoodList{{idx}}">
							...
							<td>
                 <sys:dynamicselect url="http://127.0.0.1:8082/contract/good/api/getAll" id="contractGoodList{{idx}}_goodId" name="contractGoodList[{{idx}}].goodId" valueProperty="id" textProperty="name" />
							</td>
							<td>
