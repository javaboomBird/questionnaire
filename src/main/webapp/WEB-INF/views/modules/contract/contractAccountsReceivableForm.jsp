...
<br/> <form:form
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:input
                    path="accountsReceivablePercent"
                    htmlEscape="false"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:select
                    path="accountsReceivableMethod"
                    class="input-xlarge "> <form:option
                    value=""
                    label=""/> <form:options
                    items="${fns:getDictList('cms_accounts_type')}"
                    itemLabel="label"
                    itemValue="value"
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <table
                    id="contentTable_contractAccountsReceived"
                ...
                <tr>
                    ...
                    <th>已收账款时间</th>
                    <th>备注</th>
                    <shiro:hasPermission name="contract:contractAccountsReceivable:edit">
                        <th width="10">&nbsp;</th>
                    </shiro:hasPermission>
                </tr>
                </thead>
                <tbody id="contractAccountsReceivedList"></tbody>
                <shiro:hasPermission name="contract:contractAccountsReceivable:edit">
                    <tfoot>
                    <tr>
                        <td colspan="9"><a
                                href="javascript:"
                                onclick="addRow('#contractAccountsReceivedList', contractAccountsReceivedRowIdx, contractAccountsReceivedTpl);contractAccountsReceivedRowIdx = contractAccountsReceivedRowIdx + 1;"
                                class="btn">新增</a></td>
                    </tr>
                    </tfoot>
                </shiro:hasPermission>
            ...
            <script
                    type="text/template"
                    id="contractAccountsReceivedTpl">//<!--
            ...
            <script type="text/javascript">
            var contractAccountsReceivedRowIdx = 0,
              contractAccountsReceivedTpl = $("#contractAccountsReceivedTpl").html().replace(
                /(\/\/\<!\-\-)|(\/\/\-\->)/g, "");
            $(document).ready(function () {
              var data = ${fns:toJson(contractAccountsReceivable.contractAccountsReceivedList)};
              for (var i = 0; i < data.length; i++) {
                addRow('#contractAccountsReceivedList', contractAccountsReceivedRowIdx,
                  contractAccountsReceivedTpl, data[i]);
    ...
    <div class="form-actions">
        <shiro:hasPermission name="contract:contractAccountsReceivable:edit"><input
                id="btnSubmit"
