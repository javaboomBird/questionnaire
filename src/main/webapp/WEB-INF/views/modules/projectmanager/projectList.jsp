...
<ul class="nav nav-tabs">
    ...
    <shiro:hasPermission name="projectmanager:project:edit">
        <li><a href="${ctx}/projectmanager/project/form">项目管理添加</a></li>
    </shiro:hasPermission>
</ul>
<form:form id="searchForm" modelAttribute="project" action="${ctx}/projectmanager/project/"
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <c:forEach items="${page.list}" var="project">
        <tr>
            <td><a href="${ctx}/projectmanager/project/formView?id=${project.id}">
                    ${project.projectCode}
            </a></td>
            <td>
                    ${project.projectName}
            ...
            <shiro:hasPermission name="projectmanager:project:edit">
                <td>
                    ...
                    <a href="${ctx}/projectmanager/project/delete?id=${project.id}"
                       onclick="return confirmx('确认要删除该项目管理吗？', this.href)">删除</a>
                </td>
            </shiro:hasPermission>
        </tr>
    </c:forEach>
