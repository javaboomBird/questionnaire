...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/projectmanager/projectTask/">项目任务信息管理列表</a></li>
    <li class="active"><a href="${ctx}/projectmanager/projectTask/form?id=${projectTask.id}">项目任务信息管理<shiro:hasPermission
            name="projectmanager:projectTask:edit">${not empty projectTask.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
            name="projectmanager:projectTask:edit">查看</shiro:lacksPermission></a></li>
</ul>
<br/>
<form:form id="inputForm" modelAttribute="projectTask"
                ...
                <shiro:hasPermission name="projectmanager:projectTask:edit">
                    ...
                    <tr>
                        <td colspan="4"><a href="javascript:"
                                           onclick="addRow('#projectTaskMemberList', projectTaskMemberRowIdx, projectTaskMemberTpl);projectTaskMemberRowIdx = projectTaskMemberRowIdx + 1;"
                                           class="btn">新增</a></td>
                    </tr>
                    </tfoot>
                </shiro:hasPermission>
    ...
    <div class="form-actions">
        <shiro:hasPermission name="projectmanager:projectTask:edit"><input id="btnSubmit"
