 ...
 */
package com.create80.rd.modules.customer.enterprise.web;
  ...
  @Autowired
   private AreaService areaService;
    ...
    if (StringUtils.isNotBlank(id)) {
      ...
      entity= JsonUtils.toSimpleObject(responseEntity.getBody(), EnterpriseEntity.class);
	...
	public String list(EnterpriseEntity enterprise, HttpServletRequest request, HttpServletResponse response, Model model) {
	...
	public String save(EnterpriseEntity enterprise, Model model, RedirectAttributes redirectAttributes) {
    ...
    BeanUtils.copyProperties(enterprise, type);
		restTemplate.postForEntity(apiBaseUrl+"/enterprise/enterprise/api/delete",type,String.class);
