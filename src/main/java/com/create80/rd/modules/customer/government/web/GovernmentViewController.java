  ...
  @Autowired
   private AreaService areaService;
    ...
    if (StringUtils.isNotBlank(id)) {
      ...
      entity= JsonUtils.toSimpleObject(responseEntity.getBody(), GovernmentEntity.class);
	...
	public String list(GovernmentEntity government, HttpServletRequest request, HttpServletResponse response, Model model) {
	...
	public String save(GovernmentEntity government, Model model, RedirectAttributes redirectAttributes) {
    ...
    BeanUtils.copyProperties(government, type);
		restTemplate.postForEntity(apiBaseUrl+"/government/government/api/delete",type,String.class);
