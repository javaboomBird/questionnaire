...
public class EnterpriseEntity extends DataEntity<EnterpriseEntity> {
  ...
  private List<EnterprisePollutionTypeRelationEntity> enterprisePollutionTypeRelationList = Lists
      .newArrayList();    // 子表列表
  ...
  public void setEnterpriseBusinessTypeRelationList(
      List<EnterpriseBusinessTypeRelationEntity> enterpriseBusinessTypeRelationList) {
  ...
  public void setEnterpriseIndustryTypeRelationList(
      List<EnterpriseIndustryTypeRelationEntity> enterpriseIndustryTypeRelationList) {
