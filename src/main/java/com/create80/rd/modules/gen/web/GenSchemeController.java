...
import com.create80.rd.modules.gen.service.GenSchemeService;
import com.create80.rd.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.create80.rd.modules");
		}
