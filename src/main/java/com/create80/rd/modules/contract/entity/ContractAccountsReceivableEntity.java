...
public class ContractAccountsReceivableEntity extends DataEntity<ContractAccountsReceivableEntity> {
	...
	private List<ContractAccountsReceivedEntity> contractAccountsReceivedList = Lists.newArrayList();		// 子表列表
	...
	public void setContractId(String contractId) {
		this.contractId = contractId;
	     ...
	     @Length(min=1, max=64, message="应收款序号长度必须介于 1 和 64 之间")
	public String getSn() {
		return sn;
	}
	...
	public void setContractAccountsReceivedList(List<ContractAccountsReceivedEntity> contractAccountsReceivedList) {
