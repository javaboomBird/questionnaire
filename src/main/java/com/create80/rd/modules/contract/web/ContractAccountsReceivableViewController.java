...
public class ContractAccountsReceivableViewController extends BaseController {
  ...
  public ContractAccountsReceivableEntity get(@RequestParam(required = false) String id) {
    ...
    if (StringUtils.isNotBlank(id)) {
      ...
      return JsonUtils
          .toSimpleObject(responseEntity.getBody(), ContractAccountsReceivableEntity.class);
    }
    return entity;
  }
  ...
  public String list(ContractAccountsReceivableEntity contractAccountsReceivable,
      HttpServletRequest request, HttpServletResponse response, Model model) {

    Page<ContractAccountsReceivable> page = new Page<>(request, response);
    ContractAccountsReceivable type = JsonUtils
        .toSimpleObject(JsonUtils.toJson(contractAccountsReceivable),
            ContractAccountsReceivable.class);
    ...
    ResponseEntity<String> pageResponseEntity = restTemplate
        .postForEntity(
            apiBaseUrl
                + "/contract/contractAccountsReceivable/api/list?pageNum={pageNum}&&pageSize={pageSize}",
  ...
  public String save(ContractAccountsReceivableEntity contractAccountsReceivable, Model model,
      RedirectAttributes redirectAttributes) {
    if (!beanValidator(model, contractAccountsReceivable)) {
      return form(contractAccountsReceivable, model);
    }

    ContractAccountsReceivable type = resolveBeanProperties(
        StringUtils.isEmpty(contractAccountsReceivable.getId()), contractAccountsReceivable);
    String apiBaseUrl = moduleLinkConfiguration.getLink("contract");

    restTemplate.postForObject(apiBaseUrl + "/contract/contractAccountsReceivable/api/save", type,
        String.class);
  ...
  public String delete(ContractAccountsReceivableEntity contractAccountsReceivable,
      RedirectAttributes redirectAttributes) {
    ...
    restTemplate.postForEntity(apiBaseUrl + "/contract/contractAccountsReceivable/api/delete", type,
        String.class);
  ...
  private ContractAccountsReceivable resolveBeanProperties(boolean isNewRecord, Object source) {
    ...
    ContractAccountsReceivable contractAccountsReceivable = JsonUtils
        .toSimpleObject(JsonUtils.toJson(source), ContractAccountsReceivable.class);
