...
public class ContractBillInvoicingEntity extends DataEntity<ContractBillInvoicingEntity> {
	...
	private List<ContractBillInvoicedEntity> contractBillInvoicedList = Lists.newArrayList();		// 子表列表
	...
	public void setContractId(String contractId) {
		this.contractId = contractId;
	     ...
	     @Length(min=1, max=64, message="应开票序号长度必须介于 1 和 64 之间")
	public String getSn() {
		return sn;
	}
	...
	public void setContractBillInvoicedList(List<ContractBillInvoicedEntity> contractBillInvoicedList) {
