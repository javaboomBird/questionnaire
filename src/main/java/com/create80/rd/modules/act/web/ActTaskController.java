 ...
 */
package com.create80.rd.modules.act.web;

import com.create80.rd.modules.act.entity.Act;
import com.create80.rd.modules.act.service.ActTaskService;
...
//		return "modules/act/actTaskForm";
	 ...
	 * 		vars.keys=flag,pass
	 * 		vars.values=1,true
	 * 		vars.types=S,B  @see com.create80.rd.modules.act.utils.PropertyType
	 */
